...
Returns a random hex string that can be used as a pass phrase for encrypt(). The string is a bnary encoded hexadecimal string of length 256 being generated from 128 randomly generated bytes. 
